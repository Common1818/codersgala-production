...
var DeleteButton = function DeleteButton(props) {
  ...
  var handleDelete = function handleDelete(e) {
    e.preventDefault();
    var confirm = prompt("Are you Sure you want to delete? Type CONFIRM to proceed 😮");
